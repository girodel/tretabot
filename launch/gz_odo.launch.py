...
# ================= GAZEBO BRIDGES & SENSOR SETUP =================== #
   ...
   # Añade esto arriba para obtener la ruta del archivo
    pkg_share = get_package_share_directory('my_robot_description')
    bridge_params_path = os.path.join(pkg_share, 'params', 'gazebo_bridge.yaml')

    # Cambia el nodo del bridge por este:
    ros_gz_bridge = Node(
